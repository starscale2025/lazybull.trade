...
export const COPY_BEATS: CopyBeat[] = [
  ...
  { id: "candle-foresight", from: 0.40, to: 0.475, heading: "It saw the crash coming.", sub: "Direction Ensemble · P(down) 71% · ULTRA conviction" },
  { id: "candle-vindication", from: 0.495, to: 0.55, heading: "Flagged DOWN — 12 bars early.", sub: "Reality fell into the cone it drew." },
